...
public class ProjectileStandard : MonoBehaviourPun
{
    [Header("General")]
    ...
    { 
        ...
        if (impactVFX)
        {
            GameObject impactVFXInstance = PhotonNetwork.Instantiate(impactVFX.name, point + (normal * impactVFXSpawnOffset), Quaternion.LookRotation(normal));
